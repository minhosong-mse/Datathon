...
| 주차 | 주요 활동 내용 | 활동 보고서 |
| :--- | :--- | :--- |
| **1주차** | 데이터 탐색, 연구 주제 구체화 및 방향성 설정 | [보기](링크를_입력하세요) |
| **2주차** | 데이터 전처리 및 1차 필터링 파이프라인 구축 | [보기](링크를_입력하세요) |
| **3주차** | 다층 키워드 필터링(Multi-layer) 알고리즘 적용 | [보기](링크를_입력하세요) |
| **4주차** | 데이터 시각화 및 도메인 정량 분석 | [보기](링크를_입력하세요) |
| **5주차** | 기술 패러다임 해석 및 최종 성과물 작성 | [보기](링크를_입력하세요) |
